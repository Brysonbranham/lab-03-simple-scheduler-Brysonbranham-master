...
#define TASK_D1_LED D1
#define TASK_D4_LED  D4

#define TASK_D1_LED_ON   HAL_GPIO_WritePin(LED_D1_GPIO_Port, LED_D1_Pin,GPIO_PIN_RESET);
#define TASK_D1_LED_OFF  HAL_GPIO_WritePin(LED_D1_GPIO_Port, LED_D1_Pin,GPIO_PIN_SET);
#define TASK_D1_LED_TOGGLE  HAL_GPIO_TogglePin(LED_D1_GPIO_Port, LED_D1_Pin);
#define TASK_D4_LED_ON   HAL_GPIO_WritePin(LED_D4_GPIO_Port, LED_D4_Pin,GPIO_PIN_RESET);
#define TASK_D4_LED_OFF  HAL_GPIO_WritePin(LED_D4_GPIO_Port, LED_D4_Pin,GPIO_PIN_SET);
#define TASK_D4_LED_TOGGLE  HAL_GPIO_TogglePin(LED_D4_GPIO_Port, LED_D4_Pin);
